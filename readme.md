...
![img1](tutorial-images/1.png)

1. Presionar Siguiente.

<br>
![img1](tutorial-images/2.png)

2. Seleccionar la carpeta de instalación y presionar Siguiente.

<br>
![img1](tutorial-images/3.png)
3) Seleccionar PostgreSQL Server, seleccionar pgAdmin4, Command Line Tools y presionar Siguiente.

<br>
![img1](tutorial-images/4.png)
4) Seleccionar la carpeta donde se guardaran los datos y presionar siguiente.

<br>
![img1](tutorial-images/5.png)
5) Ingresar la contraseña del superusuario y presionar siguiente.

<br>
![img1](tutorial-images/6.png)
6) Ingresar el puerto desde donde se accede a la base de datos y presionar Siguiente.

<br>
![img1](tutorial-images/7.png)
7) Seleccionar la configuración regional por defecto y presionar siguiente.

<br>
![img1](tutorial-images/8.png)
8) Verificar los parámetros de instalación y presionar siguiente.

<br>
![img1](tutorial-images/9.png)
9) Presionar siguiente para instalar.
<br>
## **HABILITAR ACCESO A IP LOCALES**

En la carpeta donde se guardarán los datos 4) debe editar el archivo pg\_hba.conf para indicar desde cuales ip locales pueden acceder a la base de datos, por defecto solo se tiene acceso desde la misma maquina osea 127.0.0.1.

## **PRUEBA DE ACCESO A LA BASE DE DATOS**

pgAdmin es el cliente por defecto por defecto de PostgreSql para acceder a los datos.

![img1](tutorial-images/10.png) 10) Buscar la aplicación y ejecutar pgAdmin.

<br>
![img1](tutorial-images/11.png)
11) Nos pedirá configurar una clave(password) para acceder de forma segura a pgAdmin, ingrese la clave y presione OK.

![img1](tutorial-images/12.png) 12) Presionar en “Add New Server” para registrar un nuevo servidor de base de datos y seleccionar un nombre para dicho servidor.

![img1](tutorial-images/13.png) 13) Cambiar a la pestaña “connection”, ingresar la ip 127.0.0.1 en el “Host Name/Address”, ingresar la clave que configuro en 5) y presione Save.

![img1](tutorial-images/14.png) 14) Desde esta aplicación en databases se debe crear la base de datos <b>**impges**</b>. Después mediante esta misma aplicación se puede hacer respaldo y restauración de la base de datos.
...
![img1](tutorial-images/15.png)
15) Si la base de datos esta en otro equipo debe indicar la ip de ese equipo en **Servidor**, en **Clave** debe ingresar la que configuro en 5) y en **Caja** debe indicar caja1 inicialmente.

![img1](tutorial-images/16.png)
16) Luego deberá autenticarse. Inicialmente puede usar la cuenta de administración que tiene usuario admin y clave vacía.

A continuación se muestran las ventanas de aplicación y se explican los componentes de estas ventanas.
<br>
##### **VENTANA PRINCIPAL**

![img1](tutorial-images/17.png)
